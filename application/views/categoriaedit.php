...
<html>
    ...
    <center>
        <div class="container">
            <h2 class="form-signin-heading">Editando...</h2>
            <form class="form-signin" role="form" method="post" action="../atualizar">
                <?php foreach ($record as $key): ?>
                    <input type="hidden" name="ID" value="<?php echo $key->ID; ?>">
                    <input type="text" class="form-control"  name="NomeCategoria" placeholder="Nome" value="<?php echo $key->NomeCategoria; ?>">
                    <input type="text" class="form-control" placeholder="Descrição" value="<?php echo $key->DescCategoria; ?>" name="DescCategoria">
